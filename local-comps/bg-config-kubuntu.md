...
По подразбиране комбинацията Alt+Shift отваря търсачката вместо да сменя езика. Това може да бъде проблем за тези, които ползват компютър с две операионни системи или два компютъра с различни ОС, едната от които не позволява свободен избор за превключване на клавиатурната подредба. Неудобството може да се реши чрез системата на Kubuntu, позволяваща свободен избор на клавишите за превключване на езика.
